...
export default function ReactSlider() {
  ...
  const data = [
    {
      ...
      description:
        "Soft leather jackets are a must-have for any fashion-conscious individual.",
      link: "DISCOVER NOW",
    },
  ...
  return (
    <div className=" w-[100vw] lg:h-[100vh] md:h-[180vh] sm:h-[300vh] mx-auto  bg-gray-200">
        ...
        <Slider {...settings}>
          {data.map((item, index) => (
            <div key={index} className="max-w-[25vw] ml-8">
              ...
              <p
                className="text-black text-lg mt-6 underline  hover:text-blue-300
    hover:duration-300 
    cursor-pointer"
              >
                {item.link}
